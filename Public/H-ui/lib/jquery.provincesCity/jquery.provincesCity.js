...
$.fn.ProvinceCity = function(){
	...
	//插入3个空的下拉框
	_self.append("<select class='select' style='width:13.33%' name='province' datatype='*' nullmsg='!'></select>");
	_self.append("<select class='select' style='width:13.33%' name='city' datatype='*' nullmsg='!'></select>");
	_self.append("<select class='select' style='width:13.33%' name='district' datatype='*' nullmsg='!'></select>");
	//分别获取3个下拉框
